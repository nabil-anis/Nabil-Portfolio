                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    {getMediaList(selectedProject)[currentMediaIndex].type === 'video' ? (
                                        ...
                                        <div className="relative max-w-full max-h-screen md:max-h-[80vh] w-full h-[80vh]">
                                            <Image
                                                src={getMediaList(selectedProject)[currentMediaIndex].src}
                                                alt={selectedProject.title}
                                                fill
                                                className="object-contain rounded-lg md:rounded-3xl shadow-2xl"
                                                sizes="90vw"
                                                priority={true} // Priority for the main lightbox image
                                            />
                                        </div>
                                    )}
                                </motion.div>
